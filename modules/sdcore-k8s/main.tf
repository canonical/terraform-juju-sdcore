...
module "amf" {
  source      = "git::https://github.com/canonical/sdcore-amf-k8s-operator//terraform?ref=chore-cc006"
...
module "nssf" {
  source      = "git::https://github.com/canonical/sdcore-nssf-k8s-operator//terraform?ref=chore-cc006"
  model       = data.juju_model.sdcore.name
  channel     = var.sdcore_channel
